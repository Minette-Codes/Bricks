...
DEBUG_DATA_LOAD: PROCEDURE EXPOSE DEBUG_DATA. FRAME. LINK. LOOKUP. SCR. SET.
  ...
  CALL DEBUG_DATA_PUSH 'SET. - Settings. (Press ENTER to continue)'
  DO TAIL OVER SET.
  ...
  CALL DEBUG_DATA_PUSH 'FRAME. - Frames. (Press ENTER to continue)'
  DO TAIL OVER FRAME.
  ...
  CALL DEBUG_DATA_PUSH 'LINK. - Frame Links. (Press ENTER to continue)'
  DO TAIL OVER LINK.
  ...
  CALL DEBUG_DATA_PUSH 'LOOKUP. - ID to row lookup. (Press ENTER to continue)'
  DO TAIL OVER LOOKUP.
  ...
  CALL DEBUG_DATA_PUSH 'SCR. - Screen data. (Press ENTER to continue)'
  DO TAIL OVER SCR.
