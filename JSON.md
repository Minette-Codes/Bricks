...
* 2026-07-12 - Added the function `JSON_URL_ENCODE(STR)`. Fixed inconsistent formatting in the map files. Fixes a few mistakes. Remove a dependency on `_JSON_SET_TYPE` in the parsing code.
